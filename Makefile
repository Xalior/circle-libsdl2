...
# ARM_ALLOW_MULTI_CORE: the shim marshals platform calls back to core 0 so an
# application can run on another core, and offers a presentation worker for one
# — neither is possible in a single-core world.
